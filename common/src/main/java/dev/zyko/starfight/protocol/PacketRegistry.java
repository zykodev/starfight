...
public class PacketRegistry {
    ...
    public static final List<Class<? extends Packet>> SERVER_PACKETS = Arrays.asList(S01PacketKeepAlive.class, S02PacketDisconnect.class, S03PacketAcceptConnection.class, S04PacketPlayOutEntitySpawn.class, S05PacketPlayOutEntityPosition.class);
